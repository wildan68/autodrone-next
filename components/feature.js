    ...
    render() {
        return (
            ...
            bg-center bg-no-repeat p-[1em] md:pt-[60px] relative overflow-hidden">
                    ...
                    <div className="text-[48px] font-[600] text-center z-10">
                        Ultra Light
                    </div>
                    <div className="text-gray text-[28px] font-[300] text-center z-10">
            ...
            bg-center bg-no-repeat p-[1em] md:pt-[60px] relative overflow-hidden">
                    ...
                    <div className="text-[48px] font-[600] text-center z-10 text-white">
                        Best Resolution
                    </div>
                    <div className="text-gray text-[28px] font-[300] text-center z-10">
